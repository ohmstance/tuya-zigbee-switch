...
| -- | -- | -- | -- | -- | :--: | :-------------------------------------- | :------------------------------ | ----: | ------: | :----- |
| 🟨 | ✔️ | 🇷 | 🔋 | ➿ | **SL** | `_TZ3000_axpdxqgu` <br> `TS0041` | [Moes 1-gang scene switch (multiple variants)](https://www.zigbee2mqtt.io/devices/ZT-B-EU1.html) |   | [`#370`](https://github.com/romasku/tuya-zigbee-switch/issues/370) [`#382`](https://github.com/romasku/tuya-zigbee-switch/issues/382) | Needs testing | 
